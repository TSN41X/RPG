public class BattleScene {
    public void fight(Person hero, Person monster, Main.FightCallback fightCallback) {
        Runnable runnable = () -> {
            int turn = 1;
    ...
    private Boolean makeHit(Person defender, Person attacker, Main.FightCallback fightCallback) {
